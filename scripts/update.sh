...
version=`curl --silent "https://api.github.com/repos/tailscale/tailscale/releases/latest" | jq .tag_name | xargs`
revision=`curl --silent "https://api.github.com/repos/tailscale/tailscale/commits/${version}" | jq .sha | xargs`
version=${version#"v"}
